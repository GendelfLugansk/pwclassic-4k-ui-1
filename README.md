...
* Маленькая иконка гильдии над головой персонажа. Технически возможно её увеличить, но такое увеличение требует
  ...
  **Если вы не против повозиться и хотите чтобы иконки над головами были увеличены, перед сборкой нужно 
  увеличить в 2 раза изображение 
  [src/surfaces.pck.files/surfaces/iconset/iconlist_guild.dds](src/surfaces.pck.files/surfaces/iconset/iconlist_guild.dds)
  (GIMP в помощь) и в файле [src/surfaces.pck.files/surfaces/iconset/iconlist_guild.txt](src/surfaces.pck.files/surfaces/iconset/iconlist_guild.txt)
  поменять в первых двух строчках 16 на 32**
